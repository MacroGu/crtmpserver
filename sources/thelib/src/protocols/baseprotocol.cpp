...
#ifdef LOG_CONSTRUCTOR_DESTRUCTOR
	FINEST("Protocol with id %""I32u""(%p) of type %s going to be deleted; F: %p,N: %p, DF: %"PRIu8", DN: %"PRIu8,
			_id,
			this,
...
#ifdef LOG_CONSTRUCTOR_DESTRUCTOR
	FINEST("Protocol with id %""I32u""(%p) of type %s deleted; F: %p,N: %p, DF: %"PRIu8", DN: %"PRIu8,
			_id,
			this,
			STR(tagToString(_type)),
			_pFarProtocol,
